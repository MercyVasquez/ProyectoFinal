		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			panel.setLayout(new BorderLayout(0, 0));
			{
				...
				panel.add(scrollPane, BorderLayout.CENTER);
				{
					...
					String[] header = {"C�digo","Nombre","Direccion","Telefono"};
			...
			}
			{
				...
				btneliminar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(!id.equals("")){
							   Cliente aux = tienda.buscarCliente(id);
							   int option = JOptionPane.showConfirmDialog(null, "Est� seguro que desea eliminar el Cliente: " + aux.getNombre(),"Informaci�n",JOptionPane.WARNING_MESSAGE);
